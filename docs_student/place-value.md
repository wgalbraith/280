...
<p><img src="./figures_static/eight-fingers.png" /></p>
<h2 id="base-8">Base 8</h2>
<ul>
<li><span> $8^0 = 1$ </span></li>
<li><span class="math display">$8^1 = 8$</span></li>
<li><span class="math display">$8^2 = 64$</span></li>
</ul>
<h2 id="binary-representation">Binary representation</h2>
<p>A base 2 system is the basis for computer representations of numbers.</p>
<p>The computer performs all calculations in binary and then converts to decimal.</p>
